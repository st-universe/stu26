...
$tar = $db->query("SELECT id,name,sx,sy,systems_id FROM stu_colonies WHERE id=".$_GET['t']." LIMIT 1",4);
if ($tar == 0) exit;
...
<input type=hidden name=s value=ss><input type=hidden name=a value=etc>

...
while($data=mysql_fetch_assoc($result))
{
	...
	echo "<br>".$data['user_id']." ".$fleetpoints[$data['user_id']]." ".$data['fleetpoints']."<br>";
	...
	if ($fleetpoints[$data['user_id']] < 0) {
		echo "<br>Schlimme Dinge!";
		$bad = rand(1,4);

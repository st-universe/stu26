<?php
// include_once("/srv/web/stu_sys/webroot_fast/inc/config.inc.php");
include_once("c:/xampp/xampp/htdocs/stu/inc/config.inc.php");
...
while($data=mysql_fetch_assoc($result))
{
	...
	{
		$fdata = $db->query("SELECT research_konstruktion,research_technik,research_verarbeitung FROM stu_user WHERE id=".$data['user_id'],4);
...
$db->query("UPDATE stu_game_vars SET value=".(time()-$time1)." WHERE var='tick2'");
?>

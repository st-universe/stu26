...
class Graph {
    ...
    public $margin_color=array(0,0,0);	// Margin color of graph
    ...
    public $titlebkg_scolor1='white',$titlebkg_scolor2='white';
    public $framebevel = false, $framebeveldepth = 2 ;
    public $framebevelborder = false, $framebevelbordercolor='white';
    public $framebevelcolor1='white@0.4', $framebevelcolor2='white@0.4';
	...
	$iXAxisLblBgFillColor = 'white', $iXAxisLblBgColor = 'white',
	$iYAxisLblBgFillColor = 'white', $iYAxisLblBgColor = 'white';
...
// PUBLIC METHODS	
    ...
    function SetFrameBevel($aDepth=3,$aBorder=false,$aBorderColor='white',$aColor1='white@0.4',$aColor2='darkgray@0.4',$aFlg=true) {
    ...
    function SetAxisLabelBackground($aType,$aXFColor='#8897cf',$aXColor='white',$aYFColor='#8897cf',$aYColor='white') {
...
//	$this->img->FilledRectangle(0,0,$this->img->width-1-$hadj,$this->img->height-1-$vadj); 
    ...
    function SetTitleBackgroundFillStyle($aStyle,$aColor1='white',$aColor2='white') {
	$this->titlebkg_fillstyle = $aStyle;
	$this->titlebkg_scolor1 = $aColor1;
	$this->titlebkg_scolor2 = $aColor2;
    }

    function SetTitleBackground($aBackColor='gray', $aStyle=TITLEBKG_STYLE1, $aFrameStyle=TITLEBKG_FRAME_NONE, $aFrameColor='white', $aFrameWeight=1, $aBevelHeight=3, $aEnable=true) {
...
//===================================================
class LineProperty {
    public $iWeight=1, $iColor="white",$iStyle="solid",$iShow=true;
...
class Text {
    ...
    protected $fcolor='white',$bcolor='white',$shadow=false;
...
class GraphTabTitle extends Text{
    ...
    private $fillcolor='lightyellow',$bordercolor='white';
    ...
    function SetColor($aTxtColor,$aFillColor='lightyellow',$aBorderColor='white') {
...
// PUBLIC METHODS
    ...
    function SetFill($aFlg=true,$aColor1='#8897cf',$aColor2='lightblue') {
	$this->fill = $aFlg;
...
// PUBLIC METHODS
	...
	if (is_string($aColor)) {
	    ...
	    // and adj=1 neutral and adj=0 white.
	    if( $adj > 1 ) {
...
class Image {
	...
	*/
    ...
    function StrokeBoxedText($x,$y,$txt,$dir=0,$fcolor="white",$bcolor="white",
...
DEFINE(\"USE_APPROX_COLORS\",true);
    ...
    function Bevel($x1,$y1,$x2,$y2,$depth=2,$color1='white@0.4',$color2='white@0.5') {
...
// PUBLIC METHODS	
    ...
    function SetColor($aFontColor,$aColor='white') {
...
//---------------
// CONSTRUCTOR
    function PlotLine($aDir=HORIZONTAL,$aPos=0,$aColor="white",$aWeight=1) {
	$this->direction = $aDir;
	$this->color=$aColor;
	$this->weight=$aWeight;
